...
namespace Appraisal_System.Models
{
     public class UserAppraisalCoefficients
    {
        ...
        public  static List<UserAppraisalCoefficients> ListAll()
        {
            ...
            DataTable dt = SqlHelper.ExecuteTable("SELECT ua.*,ac.AppraisalType,ac.AppraisalCoefficient,ac.CalculationMethod " +
                "FROM UserAppraisals ua LEFT JOIN AppraisalCoefficients ac ON ua.CoefficientId = ac.Id");
